...
namespace Caracal
{
    class LessOrEqualInstruction final : public Instruction
    {
    public:
        LessOrEqualInstruction(TemporaryId resultId, ValueRef leftValue, ValueRef rightValue, Type type, Type operandType) noexcept;
