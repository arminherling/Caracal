...
namespace Caracal
{
    class GreaterOrEqualInstruction final : public Instruction
    {
    public:
        GreaterOrEqualInstruction(TemporaryId resultId, ValueRef leftValue, ValueRef rightValue, Type type, Type operandType) noexcept;
