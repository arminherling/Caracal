...
namespace Caracal
{
    class NotEqualInstruction final : public Instruction
    {
    public:
        NotEqualInstruction(TemporaryId resultId, ValueRef leftValue, ValueRef rightValue, Type type, Type operandType) noexcept;
